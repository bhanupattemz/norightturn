...
function App() {
    ...
    const downloadPDF = async () => {
        try {
            ...
            pdf.setFontSize(16);
            pdf.text(`Self-Designed Maze Puzzle`, 10, 20);

            pdf.addImage(imgData, 'PNG', 0, marginTop, pdfWidth, imgHeight);

            pdf.save(`Self_Designed_Maze_Puzzle.pdf`);
        } catch (error) {
        ...
        <Fragment>
            {open && <div className='maze-pop-up-container'>
                <div className='maze-pop-up-body'>
                    <div className='maze-pop-up-cancel' onClick={() => setOpen(false)}><MdCancel /></div>
                    <h2>Solution</h2>
            ...
            <main className='maze-game-main'>
                <div >
                    <h2>Self-Designed Maze Puzzle</h2>
                ...
                <div className='maze-feature-btns'>
                    <button onClick={() => window.location.href = `/maze/own`}>Refresh</button>
                    <button onClick={() => {
                        handleSolutionClick()
                    }}>Solution</button>
